...
class EnterUsernameFragment : Fragment() {
    ...
    companion object {
        fun newInstance(fragmentType: String): EnterUsernameFragment {
            when (fragmentType) {
                ENTER_USERNAME -> return newInstance(
                    fragmentType,
                    "Enter your email"
                )
                ENTER_PASSWORD -> return newInstance(
                    fragmentType,
                    "Enter your password"
                )
                ENTER_EMAIL -> return newInstance(
                    fragmentType,
                    "Enter your email"
                )
                CHOOSE_PASSWORD -> return newInstance(
                    fragmentType,
                    "Choose your password"
                )
                REENTER_PASSWORD -> return newInstance(
                    fragmentType,
                    "Reenter your password"
                )
                ENTER_SCHOOL_NAME -> return newInstance(
                    fragmentType,
